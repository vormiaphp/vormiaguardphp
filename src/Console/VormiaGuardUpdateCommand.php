...
class VormiaGuardUpdateCommand extends Command
{
    protected $signature = 'vormiaguard:update';
    protected $description = 'Update VormiaGuard integration (re-run setup steps)';

    public function handle()
    {
        $this->checkSanctum();
        $this->checkVormia();
        $this->info('VormiaGuard integration updated!');
        return 0;
    }
